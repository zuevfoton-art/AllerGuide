...
function createStyles({ colors, fonts }: AppTheme) {
  return StyleSheet.create({
    ...
    editText: { fontFamily: fonts.sansSemiBold, fontSize: 12, fontWeight: '600', color: colors.head },
    ...
    reminder: { fontFamily: fonts.sansSemiBold, fontSize: 12, fontWeight: '600', color: colors.head },
