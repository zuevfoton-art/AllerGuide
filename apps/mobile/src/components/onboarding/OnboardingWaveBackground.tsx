...
/** Soft blue backdrop with organic blobs — reference onboarding style */
export function OnboardingWaveBackground({ accent, accentLight }: OnboardingWaveBackgroundProps) {
  return (
