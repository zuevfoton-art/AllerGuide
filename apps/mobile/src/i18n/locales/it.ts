...
const it: LocaleMessages = {
  ...
  auth: {
    ...
    biometric: {
      enableTitle: 'Accesso con Face ID',
      enableMessage: 'Attivare l’accesso biometrico? La prossima volta senza digitare la password.',
      enableConfirm: 'Attiva',
      enableSkip: 'Non ora',
      enableReason: 'Conferma per attivare l’accesso biometrico',
      unlockReason: 'Accedi ad A-Claro',
      loginFace: 'Accedi con Face ID',
      loginFingerprint: 'Accedi con impronta',
      loginGeneric: 'Accedi con biometria',
      failed: 'Biometria non riuscita. Accedi con la password.',
    },
  },
  profiles: {
  ...
  settings: {
    ...
    appLockTitle: 'Accesso Face ID',
    appLockHint: 'Face ID, Touch ID o codice dispositivo all’apertura e per accesso rapido',
    appLockEnable: 'Attiva',
    appLockDisable: 'Disattiva',
    appLockUnlock: 'Sblocca',
    appLockUnlockReason: 'Sblocca A-Claro',
