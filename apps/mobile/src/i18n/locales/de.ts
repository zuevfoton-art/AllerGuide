...
const de: LocaleMessages = {
  ...
  auth: {
    ...
    biometric: {
      enableTitle: 'Anmeldung mit Face ID',
      enableMessage: 'Biometrische Anmeldung aktivieren? Beim nächsten Mal ohne Passwort-Eingabe.',
      enableConfirm: 'Aktivieren',
      enableSkip: 'Nicht jetzt',
      enableReason: 'Bestätigen, um biometrische Anmeldung zu aktivieren',
      unlockReason: 'Bei A-Claro anmelden',
      loginFace: 'Mit Face ID anmelden',
      loginFingerprint: 'Mit Fingerabdruck anmelden',
      loginGeneric: 'Mit Biometrie anmelden',
      failed: 'Biometrie fehlgeschlagen. Mit Passwort anmelden.',
    },
  },
  profiles: {
    title: 'Meine Profile',
  ...
  settings: {
    ...
    appLockTitle: 'Face ID-Anmeldung',
    appLockHint: 'Face ID, Touch ID oder Gerätecode beim Öffnen der App und für schnelle Anmeldung',
    appLockEnable: 'Aktivieren',
    appLockDisable: 'Deaktivieren',
    appLockUnlock: 'Entsperren',
    appLockUnlockReason: 'A-Claro entsperren',
