...
const fr: LocaleMessages = {
  ...
  auth: {
    ...
    biometric: {
      enableTitle: 'Connexion Face ID',
      enableMessage: 'Activer la connexion biométrique ? La prochaine fois sans saisir le mot de passe.',
      enableConfirm: 'Activer',
      enableSkip: 'Pas maintenant',
      enableReason: 'Confirmez pour activer la connexion biométrique',
      unlockReason: 'Connectez-vous à A-Claro',
      loginFace: 'Connexion avec Face ID',
      loginFingerprint: 'Connexion avec empreinte',
      loginGeneric: 'Connexion biométrique',
      failed: 'Échec biométrique. Connectez-vous avec le mot de passe.',
    },
  },
  profiles: {
    title: 'Mes profils',
  ...
  settings: {
    ...
    appLockTitle: 'Connexion Face ID',
    appLockHint: 'Face ID, Touch ID ou code appareil à l’ouverture et pour une connexion rapide',
    appLockEnable: 'Activer',
    appLockDisable: 'Désactiver',
    appLockUnlock: 'Déverrouiller',
    appLockUnlockReason: 'Déverrouiller A-Claro',
    aboutTitle: 'À propos',
