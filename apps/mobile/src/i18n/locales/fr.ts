...
const fr: LocaleMessages = {
  ...
  scanner: {
    ...
    scanProductDesc: 'Code-barres via Open Food Facts, ou photo des ingrédients avec recadrage',
    ...
    cameraScanProduct: 'Code-barres ou photo des ingrédients',
    ...
    cameraProductHint: 'Scannez le code ou prenez une photo et recadrez les ingrédients',
