...
const fr: LocaleMessages = {
  ...
  home: {
    ...
    disclaimer:
      'L’indice de bien-être est informatif et ne remplace pas une consultation médicale.\nEn cas d’aggravation ou de doute, consultez un spécialiste.',
    ...
    insightsActText: 'Plus d’un mois depuis la dernière évaluation. Remplissez l’échelle dans les scores cliniques.',
  ...
  diary: {
    ...
    disclaimer:
      'Les notes du journal aident à suivre le ressenti, mais ne remplacent pas une consultation.\nNe changez pas le traitement sans avis d’un spécialiste.',
  ...
  map: {
    ...
    safePollenPlaces: 'Points à faible exposition',
    safePollenPlacesHint: 'Points modélisés à environ 20 km ; sans garantie d’air sans pollen.',
    noSafePollenPlaces: 'Aucun point proche avec un niveau modélisé faible',
    ...
    pollenSouth: 'Sud',
    pollenSouthWest: 'Sud-ouest',
    pollenWest: 'Ouest',
    pollenNorthWest: 'Nord-ouest',
    nkcc: 'NKCC',
    ...
    heatmapNoSpeciesLayer:
      'Google ne propose pas de heatmap par espèce — la carte affiche la couche arbres, graminées ou herbacées.',
  ...
  profileSetup: {
    ...
    phenotype: {
      ...
      hint: 'Basé sur ARIA (rhinite + asthme), critères ACT, polysensibilisation et chronologie. Informatif — pas un diagnostic et ne remplace pas la consultation médicale.',
  ...
  asit: {
    ...
    disclaimer: 'L’AIT est prescrite uniquement par un médecin. L’application note les prises et réactions, sans modifier doses ni schéma.',
  ...
  asthma: {
    ...
    editPlan: 'Plan',
    emptyPlan: 'Renseignez le plan et le meilleur DEP pour suivre les zones.',
    ...
    pef30d: 'mesures',
    latestPef: 'dernier DEP',
    zoneLabel: 'zone',
    logPef: 'Enregistrer DEP',
