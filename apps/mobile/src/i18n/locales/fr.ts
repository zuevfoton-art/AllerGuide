...
const fr: LocaleMessages = {
  ...
  home: {
    ...
    insightsActTitle: 'ACT à remplir',
    insightsActText: 'Plus de 4 semaines depuis la dernière évaluation du contrôle de l’asthme (GINA). Remplissez l’ACT.',
    insightsOpenAct: 'ACT',
  ...
  asthma: {
    ...
    planSubtitle: 'Zones DEP et étapes selon le médecin (orienté GINA)',
    editPlan: 'Plan',
    ...
    zoneHint: {
      green: 'Contrôle stable selon les repères GINA. Poursuivre le traitement prescrit.',
