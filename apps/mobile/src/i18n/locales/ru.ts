...
const ru: LocaleMessages = {
  ...
  scanner: {
    ...
    smartScan: 'Умный скан',
    smartScanDesc: 'Автоопределение: штрихкод, QR, меню или этикетка',
    smartScanTitle: 'Умный сканер',
    smartScanHint: 'Наведите на штрихкод, QR-код, меню ресторана или этикетку с составом',
    smartCapture: 'Снять фото',
    smartAnalyzing: 'Анализирую…',
    smartDetectedBarcode: 'Штрихкод обнаружен',
    smartDetectedQR: 'QR-код обнаружен',
    smartDetectedMenu: 'Меню обнаружено',
    smartDetectedLabel: 'Этикетка с составом обнаружена',
    smartClassifyFailed: 'Не удалось определить тип изображения. Повторите или выберите режим вручную.',
    smartNoAi: 'ИИ недоступен. Пожалуйста, выберите режим сканирования вручную.',
  },
  market: {
    title: 'Маркет',
  ...
  map: {
    ...
    pollenMapTitle: 'Пыление · {{month}}',
    pollenMapSub: 'Данные Open-Meteo / ориентир АДАИР',
    birchMapSub: 'Очаги берёзовой пыльцы на карте региона',
    birchHigh: 'Высокая концентрация берёзы',
    birchMedium: 'Средняя концентрация берёзы',
    peakSeason: 'Пик сезона: {{month}} · {{region}}',
    season: 'Сезон',
    pollenQuiet: 'В этом месяце пыление берёзы не активно',
    nkcc: 'НККЦ',
    chiefExpert: 'Главный медицинский эксперт АллерГайд',
    adairClinics: 'Клиники АДАИР',
    adairDoctors: 'Эксперты АДАИР',
    adairClinicLabel: 'Клиника АДАИР',
  ...
  settings: {
    ...
    dataStorageLocal: 'Только на устройстве',
    dataStorageLocalDesc: 'Данные остаются на вашем телефоне',
    dataStorageCloud: 'Устройство + сервер',
    dataStorageCloudDesc: 'Автоматический бэкап на сервере AllerGuide',
  },
  notifications: {
    eyebrow: 'Уведомления',
    title: 'Уведомления',
  ...
  storageOnboarding: {
    ...
    subtitle: 'Вы всегда можете изменить этот выбор в настройках приложения.',
    sectionLabel: 'Выберите способ хранения',
    localTitle: 'Только на устройстве',
    localDesc: 'Данные не покидают ваш телефон. Нет учётной записи — нет доступа третьих лиц.',
    cloudTitle: 'Устройство + сервер',
    cloudDesc: 'Автоматическая резервная копия на сервере AllerGuide. Данные доступны после переустановки приложения.',
    disclaimer: 'При хранении на сервере данные передаются по зашифрованному каналу и связаны с вашей учётной записью.',
  },
  onboarding: {
