...
const ru: LocaleMessages = {
  ...
  auth: {
    ...
    biometric: {
      enableTitle: 'Вход по Face ID',
      enableMessage: 'Включить быстрый вход по биометрии? В следующий раз можно войти без ввода пароля.',
      enableConfirm: 'Включить',
      enableSkip: 'Не сейчас',
      enableReason: 'Подтвердите, чтобы включить вход по биометрии',
      unlockReason: 'Войдите в A-Claro',
      loginFace: 'Войти с Face ID',
      loginFingerprint: 'Войти отпечатком',
      loginGeneric: 'Войти по биометрии',
      failed: 'Не удалось подтвердить биометрию. Войдите с паролем.',
    },
  },
  profiles: {
    title: 'Мои профили',
  ...
  settings: {
    ...
    appLockTitle: 'Вход по Face ID',
    appLockHint: 'Face ID, Touch ID или код устройства при открытии приложения и для быстрого входа',
    appLockEnable: 'Включить',
    appLockDisable: 'Отключить',
    appLockUnlock: 'Разблокировать',
    appLockUnlockReason: 'Разблокируйте A-Claro',
