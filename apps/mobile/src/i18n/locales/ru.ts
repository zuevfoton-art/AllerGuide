...
const ru: LocaleMessages = {
  ...
  scanner: {
    ...
    scanBarcodeDesc: 'Поиск в локальной базе штрихкодов и Open Food Facts',
    ...
    cameraBarcodeHint: 'Штрихкод проверяется в локальной базе и Open Food Facts',
    ...
    sourceBarcodesDb: 'локальная база штрихкодов',
