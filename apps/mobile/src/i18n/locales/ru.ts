...
const ru: LocaleMessages = {
  ...
  scanner: {
    ...
    cameraMenuHint: 'Сделайте фото, затем обрежьте область с текстом меню',
    cameraLabelHint: 'Сделайте фото, затем обрежьте область с составом',
    cameraMedicineHint: 'Сделайте фото, затем обрежьте область с действующими веществами',
    cameraHouseholdHint: 'Сделайте фото, затем обрежьте состав на косметике или бытовой химии',
    flashToggle: 'Вспышка',
    ...
    medicinePlaceholder: 'Состав с упаковки лекарства…',
    householdPlaceholder: 'Состав косметики или бытовой химии…',
    matches: 'Совпадения',
    ...
    pointCamera: 'Навести камеру',
    photoIngredients: 'Фото состава',
    enterManually: 'Ввести вручную',
    hideManual: 'Скрыть ввод',
    emptyHint: 'Наведите на штрихкод или состав по активному профилю.',
