...
const ru: LocaleMessages = {
  ...
  home: {
    ...
    disclaimer:
      'Индекс самочувствия носит информационный характер и не заменяет консультацию врача.\nПри ухудшении состояния или сомнениях обратитесь к специалисту.',
    ...
    insightsActText: 'Прошло больше месяца с последней оценки. Заполните шкалу в разделе клинических оценок.',
  ...
  diary: {
    ...
    disclaimer:
      'Записи в дневнике помогают отслеживать самочувствие, но не заменяют консультацию врача.\nНе меняйте лечение без рекомендации специалиста.',
    ...
    scaleRaaciHint: 'Шкалы подобраны по состоянию профиля. Уточните типы аллергии в профиле.',
  ...
  clinicalScales: {
    ...
    subtitle: 'Шкалы для отслеживания динамики. Данные сохраняются в отчётах.',
    eyebrow: 'Оценки',
  },
  diaryWizard: {
  ...
  map: {
    ...
    pollenNorth: 'Север',
    pollenNorthEast: 'Северо-восток',
    pollenEast: 'Восток',
    pollenSouthEast: 'Юго-восток',
    pollenSouth: 'Юг',
    pollenSouthWest: 'Юго-запад',
    pollenWest: 'Запад',
    pollenNorthWest: 'Северо-запад',
    nkcc: 'НККЦ',
  ...
  notifications: {
    ...
    actPushTitle: 'Пора заполнить ACT',
  ...
  profileSetup: {
    ...
    phenotype: {
      ...
      hint: 'На основе ARIA (ринит + астма), ACT-критериев, полисенсибилизации и хронологии. Информационно — не является диагнозом и не заменяет консультацию врача.',
  ...
  asit: {
    ...
    disclaimer: 'АСИТ назначается только врачом. Приложение фиксирует приёмы и реакции, но не корректирует дозировки и схему.',
  ...
  asthma: {
    ...
    editPlan: 'План',
    emptyPlan: 'Заполните план действий и лучшее ПСВ — так проще отслеживать зоны.',
