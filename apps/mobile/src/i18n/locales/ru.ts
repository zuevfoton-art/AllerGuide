...
const ru: LocaleMessages = {
  ...
  home: {
    ...
    insightsActTitle: 'Пора заполнить ACT',
    insightsActText: 'Прошло 4+ недели с последней оценки контроля астмы (GINA). Рекомендуем заполнить шкалу ACT.',
    insightsOpenAct: 'ACT',
  ...
  asthma: {
    ...
    planSubtitle: 'Зоны ПСВ и шаги по назначению врача (ориентиры GINA)',
    editPlan: 'План',
    ...
    zoneHint: {
      green: 'Контроль стабилен по ориентирам GINA. Продолжайте терапию по назначению врача.',
