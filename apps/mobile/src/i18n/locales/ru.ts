...
const ru: LocaleMessages = {
  ...
  profileSetup: {
    ...
    phenotype: {
      ...
      hint: 'На основе выбранных типов, хронологии и аллергенов. Информационно — не является диагнозом.',
      empty: 'Пока недостаточно данных для определения фенотипа.',
      disclaimer: 'Фенотипы носят рекомендательный характер и не ограничивают доступ к сканеру, карте или дневнику.',
    },
