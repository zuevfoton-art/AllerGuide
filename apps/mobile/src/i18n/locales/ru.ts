...
const ru: LocaleMessages = {
  ...
  scanner: {
    ...
    scanProductDesc: 'Штрихкод через Open Food Facts или фото состава с обрезкой',
    ...
    cameraScanProduct: 'Штрихкод или фото состава',
    ...
    cameraProductHint: 'Наведите на штрихкод или сделайте фото состава и обрежьте область',
