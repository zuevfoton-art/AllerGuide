...
const en: LocaleMessages = {
  ...
  home: {
    ...
    insightsActTitle: 'Time for ACT',
    insightsActText: 'It has been 4+ weeks since the last asthma control assessment (GINA). Please complete the ACT scale.',
    insightsOpenAct: 'ACT',
  ...
  asthma: {
    ...
    planSubtitle: 'PEF zones and steps as prescribed by your doctor (GINA-oriented)',
    editPlan: 'Plan',
    ...
    zoneHint: {
      green: 'Control appears stable per GINA-oriented guidance. Continue therapy as prescribed.',
