...
const en: LocaleMessages = {
  ...
  home: {
    ...
    disclaimer:
      'The wellness index is informational and does not replace a doctor’s consultation.\nIf you feel worse or have doubts, contact a specialist.',
    ...
    insightsActText: 'It has been more than a month since the last assessment. Complete the scale in clinical scores.',
  ...
  diary: {
    ...
    disclaimer:
      'Diary entries help track how you feel but do not replace a doctor’s consultation.\nDo not change treatment without specialist advice.',
    deleteTitle: 'Delete entry?',
    deleteMessage: 'Entry «{{type}}» will be permanently deleted.',
    saveChanges: 'Save changes',
    scale: 'Scale',
    scalePick: 'Choose a scale',
    scaleRaaciHint: 'Scales are matched to your profile. Update allergy types in the profile.',
  ...
  clinicalScales: {
    ...
    subtitle: 'Scales for tracking change. Data stay in reports.',
    eyebrow: 'Scores',
  },
  diaryWizard: {
  ...
  map: {
    ...
    pollenHeatmapTreeHint:
      'Basemap: tree pollen (Google TREE_UPI). Each of the 14 species has its own UPI in the card, not on tiles',
    pollenTreeSpeciesLevelsHint:
      'The map layer is shared for trees. Species numbers come from the plant forecast (Google or Open-Meteo).',
    ...
    safePollenPlaces: 'Low-exposure model points',
    safePollenPlacesHint: 'Model points about 20 km away; not a guarantee of pollen-free air.',
    noSafePollenPlaces: 'No nearby point with a low modeled level',
    pollenDistance: '{{distance}} km',
    pollenNorth: 'North',
    pollenNorthEast: 'North-east',
    pollenEast: 'East',
    pollenSouthEast: 'South-east',
    pollenSouth: 'South',
    pollenSouthWest: 'South-west',
    pollenWest: 'West',
    pollenNorthWest: 'North-west',
    nkcc: 'NKCC',
  ...
  profileSetup: {
    ...
    phenotype: {
      ...
      hint: 'Based on ARIA (rhinitis + asthma), ACT criteria, polysensitization and timeline. Informational — not a diagnosis and does not replace a clinician consultation.',
  ...
  asit: {
    ...
    disclaimer: 'AIT is prescribed by a doctor only. The app logs doses and reactions but does not change dosages or the schedule.',
  ...
  asthma: {
    ...
    editPlan: 'Plan',
    emptyPlan: 'Fill in your action plan and personal best PEF to track zones.',
