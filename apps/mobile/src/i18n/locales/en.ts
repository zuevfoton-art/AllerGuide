...
const en: LocaleMessages = {
  ...
  auth: {
    ...
    biometric: {
      enableTitle: 'Sign in with Face ID',
      enableMessage: 'Enable biometric sign-in? Next time you can open the app without typing your password.',
      enableConfirm: 'Enable',
      enableSkip: 'Not now',
      enableReason: 'Confirm to enable biometric sign-in',
      unlockReason: 'Sign in to A-Claro',
      loginFace: 'Sign in with Face ID',
      loginFingerprint: 'Sign in with fingerprint',
      loginGeneric: 'Sign in with biometrics',
      failed: 'Biometric check failed. Sign in with your password.',
    },
  },
  profiles: {
    title: 'My profiles',
  ...
  settings: {
    ...
    appLockTitle: 'Face ID sign-in',
    appLockHint: 'Face ID, Touch ID, or device passcode when opening the app and for quick sign-in',
    appLockEnable: 'Enable',
    appLockDisable: 'Disable',
    appLockUnlock: 'Unlock',
    appLockUnlockReason: 'Unlock A-Claro',
    aboutTitle: 'About',
