...
const en: LocaleMessages = {
  ...
  scanner: {
    ...
    smartScanDesc: 'Auto-detect: barcode, QR, menu or label',
    smartScanTitle: 'Smart Scanner',
    smartScanHint: 'Point at barcode, QR code, restaurant menu or ingredient label',
    smartCapture: 'Capture',
    smartAnalyzing: 'Analyzing…',
    smartDetectedBarcode: 'Barcode detected',
    smartDetectedQR: 'QR code detected',
    smartDetectedMenu: 'Menu detected',
    smartDetectedLabel: 'Ingredient label detected',
    smartClassifyFailed: 'Could not classify image. Try again or select mode manually.',
    smartNoAi: 'AI not available. Please select scan mode manually.',
  },
  market: {
    title: 'Market',
  ...
  map: {
    ...
    pollenMapTitle: 'Pollen · {{month}}',
    pollenMapSub: 'Open-Meteo data / ADAIR reference',
    birchMapSub: 'Birch pollen hotspots in your region',
    birchHigh: 'High birch concentration',
    birchMedium: 'Medium birch concentration',
    peakSeason: 'Peak season: {{month}} · {{region}}',
    season: 'Season',
    pollenQuiet: 'Birch pollen is not active this month',
    nkcc: 'NKCC',
    chiefExpert: 'Chief medical expert of AllerGuide',
    adairClinics: 'ADAIR Clinics',
    adairDoctors: 'ADAIR Experts',
    adairClinicLabel: 'ADAIR Clinic',
