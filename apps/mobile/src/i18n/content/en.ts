...
const enContent: LocaleContent = {
  ...
  expertHero: {
    ...
    subtitle: 'Chief Medical Expert of AllerGuide',
  },
  expertDisclaimer:
  ...
  expertArticles: {
    ...
    'food-allergy-tips': {
      ...
      body:
        ...
        'The AllerGuide scanner helps you navigate products, but it does not replace reading the label and consulting your doctor.',
    },
    'asthma-diary': {
