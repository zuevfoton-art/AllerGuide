...
function createStyles({ colors, fonts }: AppTheme) {
  return StyleSheet.create({
    ...
    inputMultiline: { minHeight: 96, lineHeight: lineHeights.body },
    allergenRow: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingVertical: 4 },
    allergenName: { flex: 1, fontFamily: fonts.sansSemiBold, fontSize: fontSizes.body, fontWeight: '600', color: colors.text },
    allergenChange: { fontFamily: fonts.sansSemiBold, fontSize: fontSizes.bodySm, fontWeight: '600', color: colors.accent },
    catalogPickerBtn: {
      flexDirection: 'row',
      alignItems: 'center',
      gap: 10,
    ...
    catalogPickerText: { flex: 1, fontFamily: fonts.sans, fontSize: fontSizes.bodyMd, color: colors.textSecondary },
    ocrBtn: {
      flexDirection: 'row',
      alignItems: 'center',
      gap: 8,
    ...
    ocrBtnText: { fontFamily: fonts.sansSemiBold, fontSize: fontSizes.bodyMd, fontWeight: '600', color: colors.accent },
    ocrHint: {
      fontFamily: fonts.sans,
