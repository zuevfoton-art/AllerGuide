  ...
  export namespace ExpoRouter {
    export interface __routes<T extends string | object = string> {
      hrefInputParams:
        ...
        | { pathname: `${'/(tabs)'}/market` | `/market`; params?: Router.UnknownInputParams }
        | { pathname: `${'/(tabs)'}/scanner` | `/scanner`; params?: Router.UnknownInputParams }
        | { pathname: `${'/(tabs)'}/sos` | `/sos`; params?: Router.UnknownInputParams };
      hrefOutputParams:
        ...
        | { pathname: `${'/(tabs)'}/market` | `/market`; params?: Router.UnknownOutputParams }
        | { pathname: `${'/(tabs)'}/scanner` | `/scanner`; params?: Router.UnknownOutputParams }
        | { pathname: `${'/(tabs)'}/sos` | `/sos`; params?: Router.UnknownOutputParams };
      href:
        ...
        | `/map${`?${string}` | `#${string}` | ''}`
        | `${'/(tabs)'}/market${`?${string}` | `#${string}` | ''}`
        | `/market${`?${string}` | `#${string}` | ''}`
        | `${'/(tabs)'}/scanner${`?${string}` | `#${string}` | ''}`
        | `/scanner${`?${string}` | `#${string}` | ''}`
        | `${'/(tabs)'}/sos${`?${string}` | `#${string}` | ''}`
        | `/sos${`?${string}` | `#${string}` | ''}`
        | { pathname: Router.RelativePathString; params?: Router.UnknownInputParams }
        | { pathname: Router.ExternalPathString; params?: Router.UnknownInputParams }
        | { pathname: `/`; params?: Router.UnknownInputParams }
