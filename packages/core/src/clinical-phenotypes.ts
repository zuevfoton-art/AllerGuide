...
const REASSESSMENT_HINTS: Partial<Record<ClinicalPhenotypeId, string>> = {
  ...
  'aria-asthma':
    'При сочетании ринита и астмы полезно регулярно отмечать самочувствие в разделе оценок.',
  'atopic-march-child':
    'При атопическом марше отслеживайте кожу, нос и дыхание — это поможет врачу оценить динамику.',
  'insect-venom-severe':
