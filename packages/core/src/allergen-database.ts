...
export const ALLERGENS: AllergenRecord[] = [
  ...
  },
  {
    ...
    category: 'food',
    popular: false,
    keywords: ['дын', 'арбуз', 'огурц', 'кабач', 'цуккини', 'тыкв'],
  },
  {
    id: 'chestnut',
    name: 'Каштан',
  ...
  },
  {
    ...
    category: 'food',
    popular: false,
    keywords: ['ячмен', 'ячнев', 'перлов'],
  },
  {
    id: 'other-fish',
    name: 'Другие виды рыб',
    category: 'food',
    popular: false,
    keywords: ['треск', 'лосос', 'форель', 'скумбр', 'сельд', 'тунец', 'камбал', 'судак', 'минтай'],
  },
  {
    id: 'birch-pollen',
    name: 'Пыльца берёзы',
  ...
  },
  {
    ...
    category: 'environmental',
    popular: false,
    keywords: ['злак', 'тимофеевк', 'лугов', 'райграс', 'овсяниц'],
  },
  {
    id: 'hazel-pollen',
    name: 'Пыльца лещины',
  ...
  },
  {
    ...
    category: 'environmental',
    popular: false,
    keywords: ['грызун', 'хомяк', 'крыс', 'мыш', 'морск свин'],
  },
  {
    id: 'bird',
    name: 'Птицы',
    category: 'environmental',
    popular: false,
    keywords: ['птиц', 'перо', 'попуг', 'канар'],
  },
  {
    id: 'horse',
    name: 'Лошади',
  ...
  },
  {
    ...
    category: 'medication',
    popular: false,
    keywords: ['ибупрофен', 'нурофен', 'диклофенак', 'кетопрофен', 'напроксен', 'нпвп', 'нпвс'],
  },
  {
    id: 'cephalosporins',
    name: 'Цефалоспорины',
    category: 'medication',
    popular: false,
    keywords: ['цефалоспорин', 'цефазолин', 'цефтриаксон', 'цефуроксим', 'цефиксим'],
  },
  {
    id: 'paracetamol',
    name: 'Парацетамол',
    category: 'medication',
    popular: false,
    keywords: ['парацетамол', 'ацетаминофен', 'панадол', 'эффералган'],
  },
  {
    id: 'bee-venom',
    name: 'Пчёлы',
    category: 'insect',
    popular: false,
    keywords: ['пчел', 'пчелин', 'medical honeybee'],
  },
  {
    id: 'wasp-venom',
    name: 'Осы',
    category: 'insect',
    popular: false,
    keywords: ['ос', 'осин', 'осы', 'yellow jacket'],
  },
  {
    id: 'hornet-venom',
    name: 'Шершни',
  ...
  },
  {
    ...
    category: 'insect',
    popular: false,
    keywords: ['комар', 'комарин'],
  },
  /** @deprecated Legacy aggregate — prefer bee/wasp/hornet/mosquito ids. Kept for stored profiles. */
  {
    id: 'insect-stings',
    name: 'Укусы насекомых',
    category: 'insect',
    popular: false,
    keywords: ['насеком', 'укус насеком'],
  },
];
