...
| Оба джоба: `Failed to find package 'tools'` на `setup-android@v3` | Nightly 34939781509: cmdline-tools 16.0, Google убрал obsolete SDK `tools`. Тот же SHA зелёный 13–14 Sep. `packages: platform-tools`; platforms/build-tools ставит следующий шаг |
