...
| `Слабый` не найден на шаге кожи | После ввода «покраснение» Gboard + футер сминают чипы (nightly 34336499730, bounds `[266,1617][394,1396]`). `_tap-wizard-choice.yaml` закрывает IME, `scrollUntilVisible` `diary-choice-*` |
