...
|---------|--------------------------|
| Геймификация стриков / бейджи «30 дней подряд» | Стыд при пропуске; конфликт с аллергическим контролем |
| AI-компаньон как главный экран | Нет клинической ответственности; offline-first |
...
**Не делать в этих фазах:** новый шрифт ради «ещё wellness»; AI-чат на Главной; геймификация стриков; перенос клинических порогов в UI; новые hex в JSX (только `theme.ts` + бренд-док).

Связь с уже написанным [`ux-improvement-plan.md`](./ux-improvement-plan.md): этапы A–E — ремонт текущего каркаса. North-star **заменяет каркас**. Если A–E ещё не все закрыты, N1 всё равно важнее оставшихся полировок 6-го таба.
