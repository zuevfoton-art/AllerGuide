...
| 1.6a | После неверного пароля — подсказка «восстановить по email» | ☐ | ☐ | ☐ | |
| 1.6b | «Забыли пароль?» → `/forgot-password`, запрос ссылки на email | ☐ | ☐ | ☐ | Backend auth + Resend |
| 1.6c | Ссылка из письма → `/reset-password?token=…` → новый пароль → вход | ☐ | ☐ | ☐ | Токен 1 час |
...
| # | Сценарий | iOS | Android | Web | Примечания |
|---|----------|-----|---------|-----|------------|
| 3.1 | ProfileSwitcher на главной / дневнике / сканере / SOS | ☐ | ☐ | ☐ | |
...
| # | Сценарий | iOS | Android | Web | Примечания |
|---|----------|-----|---------|-----|------------|
| 4.1 | Document header «AllerGuide · …» | ☐ | ☐ | ☐ | Clinical Calm |
| 4.2 | Кнопка SOS в шапке → экран SOS | ☐ | ☐ | ☐ | |
| 4.3 | Wellness index загружается (Open-Meteo) | ☐ | ☐ | ☐ | нужен интернет |
| 4.4 | «Подробнее» → карта | ☐ | ☐ | ☐ | |
...
| # | Сценарий | iOS | Android | Web | Примечания |
|---|----------|-----|---------|-----|------------|
| 5.1 | Список записей для активного профиля | ☐ | ☐ | ☐ | |
...
| 6.4 | Ручной ввод штрихкода / поиск | ☐ | ☐ | ☐ | web fallback |
...
| 7.3 | Редактирование SOS → `/sos-edit` | ☐ | ☐ | ☐ | |
| 7.4 | Экстренные контакты: добавить / удалить | ☐ | ☐ | ☐ | |
| 7.5 | Ссылка на Settings | ☐ | ☐ | ☐ | |
