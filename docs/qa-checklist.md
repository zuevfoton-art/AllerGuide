...
| # | Сценарий | iOS | Android | Web | Примечания |
|---|----------|-----|---------|-----|------------|
| 4.1 | Центрированный бренд-header (абсолютный центр) и слоган «Aclearo — когда важна ясность»; тот же header на stack-экранах | ☐ | ☐ | ☐ | `ScreenBrandHeader` / `ScreenBackBrandHeader` |
