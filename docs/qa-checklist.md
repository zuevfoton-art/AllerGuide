...
| 1.6d | После регистрации/входа — предложение включить Face ID | ☐ | ☐ | ☐ | Нативный диалог |
| 1.6e | Повторный вход кнопкой Face ID / отпечаток | ☐ | ☐ | ☐ | После logout |
| 1.6f | Холодный старт с сессией — разблокировка биометрией | ☐ | ☐ | ☐ | AppLockGate |
