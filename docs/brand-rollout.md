...
- Единый header: знак + слоган «Aclearo — когда важна ясность» слева (`brand.slogan`, `ScreenBrandHeader`); тап после входа открывает главную. Вход/регистрация — центрированный `AuthHero`.
